require '/home/dell/Documents/ruby/shop/shopcart'
...
describe "Shop_cart" do
    ...
    describe "Testing of add_product_to_stock => " do
        it "it should add the new product in the stock" do
            ...
            expect{add_product_to_stock}.to output("\nEnter the name of the product: \nEnter the description of the product: \nEnter the price of the product: \nEnter the quantity of the product: \nProduct 'Oneplus buds' has successfully added").to_stdout
            expect($stock.size).to eq(1)
            expect($stock["Oneplus buds"][:description]).to eq("12.4 mm driver size")
            expect($stock["Oneplus buds"][:price]).to eq(1500.0)
            expect($stock["Oneplus buds"][:quantity]).to eq(20)
        end
    end
